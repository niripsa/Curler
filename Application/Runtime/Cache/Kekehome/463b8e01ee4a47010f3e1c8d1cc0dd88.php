...
<head>
    ...
    <link href="<?php echo (VIEW_PATH); ?>mod/style.css" rel="stylesheet" type="text/css">
    <script src="<?php echo (VIEW_PATH); ?>mod/jquery.js"></script>    

    <style>
        .btn-login {
            background: url(<?php echo (VIEW_PATH); ?>images/login/btn.png) no-repeat;
            margin-top: 26px;
            font-size: 30px;
            color: #ffffff;
            margin-left: 200px;
        ...
        .btn-text {
            background: url(<?php echo (VIEW_PATH); ?>images/login/l_login_t_b.png) no-repeat;
            width: 350px;
            height: 40px;
            margin-left: 120px;
            padding-left: 30px;
        ...
        .v-b-s {
            background: url(<?php echo (VIEW_PATH); ?>images/login/v_b.png) no-repeat;
            padding-left: 30px;
            outline: none;
        }
...
<body>
    ...
    <input readonly="true" style="background: url(<?php echo (VIEW_PATH); ?>images/login/l_l_t.png) no-repeat; width: 700px; height: 100px; font-size: 30px; color: #ffffff; padding-left: 120px; padding-top: 5px;" value="可可家园，一款惊奇的游戏！">
...
<div>
	...
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="i4OPunwygdxrNKk9mzcOp8XOC0CxmrlhUeZmF5AC31PkqFnQaxPkBuxPJLWql4gIm++qj95qEzhcjx8m2B8kvKgwUDXnk/ADizc0k2Pws7d/uzRpZ1Fs5cdc/DoVkDlEpmIGqtbBB28JO9md8h3Qis7rHVNn8E87g5hxw/ZSmkbXuli78WXLbtDolhxoREA0">
          ...
          <div style="background: url(<?php echo (VIEW_PATH); ?>images/login/l_login_b.png) no-repeat; width: 600px; height: 430px; margin-top: 50px; margin-left: 350px; position: relative;">
	...
	<script src="<?php echo (VIEW_PATH); ?>ui/js/jquery.min.js"></script>
    <script src="<?php echo (VIEW_PATH); ?>ui/js/bootstrap.min.js"></script>
    <script src="<?php echo (VIEW_PATH); ?>ui/js/jquery.backstretch.min.js"></script>
    <script src="<?php echo (VIEW_PATH); ?>ui/layer/layer.js"></script>
    <script src="<?php echo (VIEW_PATH); ?>ui/js/long.js"></script>
    ...
    <script>		
		...
		$.backstretch(["<?php echo (VIEW_PATH); ?>ui/images/dl.jpg"], {
		          fade: 100,
		          duration: 100
		      });
    </script>
