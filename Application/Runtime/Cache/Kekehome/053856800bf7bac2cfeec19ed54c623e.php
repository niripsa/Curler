...
<head>
    ...
    <link href="./Application/Kekehome/View/mod/style.css" rel="stylesheet" type="text/css">
    <script src="./Application/Kekehome/View/mod/jquery.js"></script>    

    <style>
        .btn-login {
            background: url(./Application/Kekehome/View/images/login/btn.png) no-repeat;
            margin-top: 26px;
            font-size: 30px;
            color: #ffffff;
            margin-left: 200px;
        ...
        .btn-text {
            background: url(./Application/Kekehome/View/images/login/l_login_t_b.png) no-repeat;
            width: 350px;
            height: 40px;
            margin-left: 120px;
            padding-left: 30px;
        ...
        .v-b-s {
            background: url(./Application/Kekehome/View/images/login/v_b.png) no-repeat;
            padding-left: 30px;
            outline: none;
        }
...
<body>
    ...
    <input readonly="true" style="background: url(./Application/Kekehome/View/images/login/l_l_t.png) no-repeat; width: 700px; height: 100px; font-size: 30px; color: #ffffff; padding-left: 120px; padding-top: 5px;" value="可可家园，一款惊奇的游戏！">
...
<div>
	...
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="i4OPunwygdxrNKk9mzcOp8XOC0CxmrlhUeZmF5AC31PkqFnQaxPkBuxPJLWql4gIm++qj95qEzhcjx8m2B8kvKgwUDXnk/ADizc0k2Pws7d/uzRpZ1Fs5cdc/DoVkDlEpmIGqtbBB28JO9md8h3Qis7rHVNn8E87g5hxw/ZSmkbXuli78WXLbtDolhxoREA0">
          ...
          <div style="background: url(./Application/Kekehome/View/images/login/l_login_b.png) no-repeat; width: 600px; height: 430px; margin-top: 50px; margin-left: 350px; position: relative;">
         <input name="UserId" type="text" id="username" value="" class="btn-text" placeholder="用户名" onclick=" JavaScript: this.value = &#39;&#39;; " style="border-width:0px;margin-top: 140px">
	...
	<script src="./Application/Kekehome/View/ui/js/jquery.min.js"></script>
    <script src="./Application/Kekehome/View/ui/js/bootstrap.min.js"></script>
    <script src="./Application/Kekehome/View/ui/js/jquery.backstretch.min.js"></script>
    <script src="./Application/Kekehome/View/ui/layer/layer.js"></script>
    <script src="./Application/Kekehome/View/ui/js/long.js"></script>
    ...
    <script>		
		...
		$.backstretch(["./Application/Kekehome/View/ui/images/dl.jpg"], {
		          fade: 100,
		          duration: 100
		      });
    </script>
